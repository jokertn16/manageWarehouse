                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <img class="direct-chat-img"
										src="${pageContext.request.contextPath }/resources/user/dist/img/user1-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img"
										src="${pageContext.request.contextPath }/resources/user/dist/img/user3-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                     Good Shop
                    </div>
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="contacts-list-img"
											src="${pageContext.request.contextPath }/resources/user/dist/img/user1-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img"
											src="${pageContext.request.contextPath }/resources/user/dist/img/user7-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img"
											src="${pageContext.request.contextPath }/resources/user/dist/img/user3-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img"
											src="${pageContext.request.contextPath }/resources/user/dist/img/user5-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img"
											src="${pageContext.request.contextPath }/resources/user/dist/img/user6-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img"
											src="${pageContext.request.contextPath }/resources/user/dist/img/user8-128x128.jpg" alt="User Avatar">
          ...
          <section class="col-lg-5 connectedSortable">
            ...
            <div class="card bg-gradient-primary">
              <div class="card-header border-0">
                ...
                <div class="card-tools">
                  <button type="button"
									class="btn btn-primary btn-sm daterange" title="Date range">
